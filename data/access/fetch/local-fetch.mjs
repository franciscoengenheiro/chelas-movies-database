...
const data = {
    [MOST_POPULAR_MOVIES]: './data/local/most-popular-movies.json',
    [MOVIES_SEARCHED_BY_NAME + "inception 2010"]: './data/local/movies-searched-by-name.json',
    [MOVIE_INFO + "tt0468569"]: './data/local/movie-info.json'
}
